...
*}
<div id="moneytigo_redirect">
	{if $isCartEmpty == true}
	<p style="color:red; text-align:center;">
		{l s='Forbidden ! You couldn\'t view this page. Please make an order. ' mod='moneytigo'}
	</p>
    {else}
	<h2 style="text-align:center;">{l s='Redirect to the payment page' mod='moneytigo'}</h2>
	<p style="text-align:center;">
		<a href="javascript:$('#moneytigo_form').submit();" id="btnForForm">{l s='You will now be redirected to moneytigo. If this does not happen automatically, please press here.' mod='moneytigo'}</a>
	</p>
